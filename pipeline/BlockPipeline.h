#ifndef _INC_BlockPipeline_H
#define _INC_BlockPipeline_H
...
{
public:
    BlockPipeline(int _rows, int _cols, float _th1, int _k, int _GFSize, int _GFs1, int _GFs2, float _th2, bool _returnH)
